    ...
    <div class="stack">
        ...
        <div class="as-search-wrapper" role="main">
            <div class="as-navtuck-wrapper">
             ...
             <?php $estado = isset($_GET['estado'])?$_GET['estado']:"";
                                        echo ($estado?"<div><p style='text-align:center' class='msg'>":"");
                                        switch ($estado) {
                                            case 'failure':
                                                echo "El pago ha sido rechazado o no ha finalizado";
                                                break;
                                            case 'success':
                                                echo "Su pago ha sido exitoso, pronto le enviaremos el producto solicitado, muchas gracias<br />
                                                payment_method_id = ".$_GET['payment_type']."<br />
                                                external_reference = ".$_GET['external_reference']."<br />
                                                Id del pago = ".$_GET['collection_id'] ;
                                                break;
                                            case 'pending':
                                                echo "Su pago está pendiente";
                                                break;
                                             default:
                                                echo "";
                                                 break;

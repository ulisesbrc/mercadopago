...
/*    $item1 = new MercadoPago\Item();
    ...
    $item1->title = $title; 
    $item1->quantity = $unit;
    $item1->unit_price = $price;
*/
//$preference->items = array($item1);
//$preference->save();
$imagen = substr($_POST['img'],1);
$imagen = "https://programador-php.net/mp-ecommerce-php".$imagen ;
$item = array( 
    "title"=> "$title",
    "id"=> $id,
...
$back_urls = array(
    "success"=> "https://programador-php.net/mp-ecommerce-php?estado=success",
    "failure"=> "https://programador-php.net/mp-ecommerce-php?estado=failure",
    "pending"=> "https://programador-php.net/mp-ecommerce-php?estado=pending");

$exc =array("id"=> "amex");
$exc2= array("id"=> "atm");
$payment_methods["excluded_payment_methods"]= array($exc);
$payment_methods["excluded_payment_types"]= array($exc2);
$payment_methods["installments"]= 6;
$data = [
    "items" => array($item),
    "payer" =>$payer,
    "payment_methods"=> $payment_methods,
    "external_reference"=>"ulises4@gmail.com",
    "back_urls" => $back_urls,
    "notification_url" =>"https://programador-php.net/mp-ecommerce-php/ipn.php",
...
mail('ulises4@gmail.com', 'PREFERENCIA '.date('h:i:s'), $datos->id." --- ".$result);
?>
<button type="submit" class="mercadopago-button" onclick="pagar('<?php echo $datos->init_point; ?>')">Pagar la compra</button>
                                </div>
                            </div>
                        </div>
                    </div>
